...
ADD CONSTRAINT FK_Comments_Tickets FOREIGN KEY (TicketId) REFERENCES Tickets(Id) ON DELETE CASCADE,
    CONSTRAINT FK_Comments_Users FOREIGN KEY (UserId) REFERENCES Users(Id) ON DELETE SET NULL;

ALTER TABLE ProjectRoles
ADD CONSTRAINT FK_ProjectRoles_Projects FOREIGN KEY (ProjectId) REFERENCES Projects(Id) ON DELETE CASCADE;

ALTER TABLE ProjectRolePermissions
ADD CONSTRAINT FK_ProjectRolePermissions_ProjectRoles FOREIGN KEY (ProjectRoleId) REFERENCES ProjectRoles(Id) ON DELETE CASCADE,
    CONSTRAINT FK_ProjectRolePermissions_Permissions FOREIGN KEY (PermissionId) REFERENCES [Permissions](Id) ON DELETE CASCADE;
...
ADD CONSTRAINT FK_ProjectUserRoles_Projects FOREIGN KEY (ProjectId) REFERENCES Projects(Id) ON DELETE NO ACTION,
    CONSTRAINT FK_ProjectUserRoles_ProjectRoles FOREIGN KEY (ProjectRoleId) REFERENCES ProjectRoles(Id) ON DELETE CASCADE,
    CONSTRAINT FK_ProjectUserRoles_Users FOREIGN KEY (UserId) REFERENCES Users(Id) ON DELETE CASCADE;
